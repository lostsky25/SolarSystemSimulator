...
sf::Vector2f GetDesktopResolution(void);

int main(int argc, char **argv) {

	sf::Vector2f winDesktop = GetDesktopResolution();

	static float width = winDesktop.x;
	static float height = winDesktop.y;
